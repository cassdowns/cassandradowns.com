...
const works = [
    {
        ...
        description: [
            ...
            '<p class="formNote">Original sculpture in a private collection, Melbourne.</p>',
            '<p class="formNote">Exhibited: Koorie Art Show, Koorie Heritage Trust, Melbourne, 2021</p>',
            '<p class="formNote">Part of the \'Pre-Fire\' print series</p>'
        ],
        link: {
...
const prints = [
    {
        ...
        formNote: 'Submitting this form reserves your interest, you will receive a follow up by email to confirm payment and arrange shipping.',
